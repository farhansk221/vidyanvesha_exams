...
export default function EditTotalMarksAnonymousPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await ExamTotalMarksAnonymousService.update(Number(id), formData as any);
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold tracking-tight">Edit Total Marks Record</h1>
