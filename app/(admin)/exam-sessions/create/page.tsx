    ...
    return (
        <div className="p-6 max-w-4xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold tracking-tight">Create Exam Session</h1>
                    <p className="text-muted-foreground">Fill in the details to create a new exam session</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Enter the core exam session details</CardDescription>
                    </CardHeader>
