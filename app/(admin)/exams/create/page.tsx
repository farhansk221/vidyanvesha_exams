...
const defaultFormData: Omit<Exam, "id"> = {
    exam_session: null,
    stud_class: 101,
    prog: null,
    prog_rev: null,
...
export default function CreateExamPage() {
    ...
    const [formData, setFormData] = useState<Omit<Exam, "id">>(defaultFormData);
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Link the exam to a session, program, and course</CardDescription>
                    </CardHeader>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Configure exam type, marks, and schedule</CardDescription>
                    </CardHeader>
                    <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Configure question paper requirements and freezing</CardDescription>
                    </CardHeader>
                    <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="flex items-center justify-between rounded-lg border p-4">
                            <div className="space-y-0.5">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Assign staff and configure student settings</CardDescription>
                    </CardHeader>
                    <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Configure grace marks, penalties, and mark settings</CardDescription>
                    </CardHeader>
                    <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="flex items-center justify-between rounded-lg border p-4">
                            <div className="space-y-0.5">
