        ...
        <div className="p-6 max-w-4xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground">Fill in the details to create a new question paper</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Enter the name, code, pattern, and marks for the question paper</CardDescription>
                    </CardHeader>
