...
export default function CreateExamOutcomePage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.error("Failed to create exam outcome.");
        } finally {
        ...
        <div className="p-6 max-w-4xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground">Record an exam outcome with score details</p>
                </div>
            </div>
                ...
                <Card>
                    ...
                    <CardFooter className="flex justify-end gap-4 border-t pt-6">
                        ...
                        <Button type="submit" disabled={isSubmitting}>
                            {isSubmitting ? "Creating..." : "Create Exam Outcome"}
                        </Button>
                    </CardFooter>
                </Card>
            </form>
